...
void tcp_client::write(char *data, int len) { tcp_conn_->write(data, len); }

void tcp_client::shutdown() { tcp_conn_->shutdown(); }
void tcp_client::close() { tcp_conn_->close(); }

void tcp_client::set_user_data(const pp::any &any) { any_ = any; }
