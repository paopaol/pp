...
using namespace std;
namespace strings {
bool isSpace(unsigned char c) { return (bool)isspace((unsigned char)c); }
...
string ToUpper(const string &str) {
  ...
  transform(upperString.begin(), upperString.end(), upperString.begin(),
            ::toupper);
  return upperString;
}
...
vector<string> &Split(vector<string> &vstr, const string &str,
