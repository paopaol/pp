...
void event_fd::set_active(int events) { active_event_ = events; }
...
int event_fd::enabled_event() { return enabled_event_; }
...
event_loop *event_fd::its_loop() { return event_loop_; }
