...
public:
  ...
  void set_user_data(const pp::any &any) { user_data_ = any; }

  pp::any user_data() { return user_data_; }
...
private:
  ...
  void start_write(const void *data, size_t len, errors::error_code &error);
