...
private:
  ...
  void write_headers(const tcp_conn_wref &conn, const http_conn_ctx_wref &ctx);
  void write_body(const tcp_conn_wref &conn, const http_conn_ctx_wref &ctx);
  void remove_client(const http_conn_ctx_ref &client);
  void add_client(const tcp_client_ref &client, const http_conn_ctx_ref &ctx);
